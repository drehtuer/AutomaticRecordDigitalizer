...
| Deck I/O | Optocoupler board (4 channels) | 1 | 5 |
...
Not included: the 3D printer, the turntable, the Focusrite Scarlett (owned), and an external phono preamp if the deck's own line output is not used (about 40 €).
