...
**The electronics box, and where the Pi lives.** *A decision, before the panel is drilled.* At 260 × 180 × 90 mm the box under the station cannot hold the Octopus (160 × 110), the 150 W supply (159 × 97), the Pi, the relay card, the pump, the valve and the hub: the footprints are 116 % of the floor before any clearance. Either the box grows to about 360 × 260 × 110, or the supply goes under the bench and the pump on a rubber mount outside it — the better machine, since the pump is a vibration source and the supply wants air. Separately, the deck camera's ribbon runs 1.07 m from that box to the end panel, twice the 0.5 m bought and at the edge of what CSI tolerates. A 1.3 m ribbon is the cheap try; moving the Pi with its whole USB group — hub, SSD, Scarlett, relay card — to an enclosure on the deck-end panel, where three of the four want to be anyway, makes the ribbon the 0.5 m already bought and leaves only the Octopus USB lead and the MPRLS I²C lead crossing to the station box. `08-assembly-instructions.md` lays both out.
