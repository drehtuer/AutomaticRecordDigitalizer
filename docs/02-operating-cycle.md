...
**1. Pick from carousel.** At travel height the gantry positions the wrist above the gap beside the spoke at the pick position. The arm descends into the 6.5 cm gap with the cup about 1 cm from the record's face. The wrist camera reads the centre hole position, photographs the label, and measures the lead-in and run-out radii. The cup moves along Y onto the label, vacuum on, the vacuum switch confirms the seal, and the record lifts straight up out of its slot. Spokes never touch.
...
Every move between two poses is a list of waypoints, one axis at a time, generated by a planner with these rules:
