...
STATION_CUP = (P.ST_X, P.ST_Y, RING_TOP - P.CUP_H / 2)             # cup up; the held record's underside sits CUP_H/2 above the cup point, so it meets the ring top exactly when set down
